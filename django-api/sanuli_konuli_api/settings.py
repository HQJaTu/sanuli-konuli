"""
Django settings for sanuli_konuli_api project.
...
ROOT_URLCONF = 'sanuli_konuli_api.urls'
...
WSGI_APPLICATION = 'sanuli_konuli_api.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "Sanuli-Konuli - API",
    "DESCRIPTION": "Sanuli-Konuli API for solving Wordle-style puzzles",
    "TOS": None,
...
# List of dictionaries to offer
# Format:
# <lang> : <word length> : <path to dictionary .dat -file>
